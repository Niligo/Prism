...
public class ColorPicker extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
        ...
        COLORS = new int[] {
                getResources().getColor(R.color.colorpicker3),
                getResources().getColor(R.color.colorpicker4),
                getResources().getColor(R.color.colorpicker5),
                getResources().getColor(R.color.colorpicker6),
                getResources().getColor(R.color.colorpicker1),
                getResources().getColor(R.color.colorpicker2),
                getResources().getColor(R.color.colorpicker3),
        };
        ...
        if (!isInEditMode())
        {
            ...
            gradientMatrix.preRotate(30f, 0, 0);
            s.setLocalMatrix(gradientMatrix);
        }
